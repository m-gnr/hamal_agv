...
class LineNode(Node):
    ...
    def process_frame(self, frame):
        ...
        # Tüm görüntü yerine zemine yakın tek bir satır kullanılır. Bu hem
        # hesap yükünü azaltır hem de forklift gövdesinin üst bölgedeki
        # ilgisiz ayrıntılarından etkilenmeyi sınırlar.
        ...
        # Beyaz bölgenin iki ucu çizgiyi temsil eder; orta noktanın görüntü
        # merkezinden farkı, görev düğümünün kullandığı yönlendirme hatasıdır.
        left = int(white[0])
        right = int(white[-1])
        center = (left + right) // 2
    ...
    def update_detection_state(self, detected):
        ...
        # Tek karelik parazit yüzünden durum değiştirmemek için ardışık
        # başarılı/başarısız kare sayısı ile kararlı durum üretilir.
        if (
